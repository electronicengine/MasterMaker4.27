...
#include "../widget/ChatBoxWidget.h"
...
void AUserCharacter::llamaResponseCallBack(const std::string& responsePiece) {
...
void AUserCharacter::moveRemote(float Value, const FVector &Direction)
{
    AddMovementInput(Direction, Value);
