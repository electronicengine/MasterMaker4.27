...
TSharedPtr<FJsonObject> UMasterMakerSaveGame::convertConstructionInfoToJson(const FConstructionInfo& Info)
{
    ...
    json->SetStringField("Plugin_Relative_Location", Info.Plugin_Relative_Location.ToString());
    ...
    json->SetStringField("Item_Name", Info.Item_Options.Name);
    json->SetStringField("Item_Category_Name", Info.Item_Options.CategoryName);
    json->SetStringField("Item_Color", Info.Item_Options.Color.ToString());
...
FConstructionInfo UMasterMakerSaveGame::convertJsonToConstructionInfo(const TSharedPtr<FJsonObject>& Json)
{
    ...
    main_brick_info.Plugin_Relative_Location.InitFromString(Json->GetStringField("Plugin_Relative_Location"));
    ...
    main_brick_info.Item_Options.Name = Json->GetStringField("Item_Name");
    main_brick_info.Item_Options.CategoryName = Json->GetStringField("Item_Category_Name");
    main_brick_info.Item_Options.Color.InitFromString(Json->GetStringField("Item_Color"));
