...
ABullet::ABullet()
{
    ...
    static ConstructorHelpers::FObjectFinder<UStaticMesh>
        static_mesh_asset(TEXT("StaticMesh'/Game/bricks/meshes/weapons/bullet.bullet'"));
    ...
    static ConstructorHelpers::FObjectFinder<UMaterial>
        material_asset(TEXT("Material'/Game/bricks/materials/bullet_material.bullet_material'"));
