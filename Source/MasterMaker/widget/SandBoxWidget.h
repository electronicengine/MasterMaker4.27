...
class MASTERMAKER_API USandBoxWidget : public UUserWidget
{
    ...
    std::vector<std::tuple<FString, UButton*, FString>> GeneralBrick_Buttons;
    std::vector<std::tuple<FString, UButton*, FString>> WeaponBrick_Buttons;
    std::vector<std::tuple<FString, UButton*, FString>> VehicleBrick_Buttons;
    std::vector<std::tuple<FString, UButton*, FString>> BuildingBrick_Buttons;
    std::vector<std::tuple<FString, UButton*, FString>> MechanicBrick_Buttons;
    std::vector<std::tuple<FString, UButton*, FString>> Character_Buttons;

    std::vector<std::tuple<FString, UButton*, FString>> Color_Buttons;


    std::vector<std::tuple<FString, UButton*, FString>>* Current_Category_Buttons;
    ...
    void removeWidget();
    void checkCategory();
    UButton* createItemButton(UObject* asset, std::vector<std::tuple<FString, UButton*, FString>>& Buttons);
    void setButtonHover(UObject* asset, UButton* Btn);
    void setVisibilityCategoryButtons(const std::vector<std::tuple<FString, UButton*, FString>>& CategoryButtons, bool Visible);
