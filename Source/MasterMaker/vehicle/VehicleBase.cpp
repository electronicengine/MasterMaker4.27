...

{
    ...
    plugMesh = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("plug"));
    plugMesh->SetupAttachment(RootComponent);
    plugMesh->SetCollisionEnabled(ECollisionEnabled::NoCollision);
    plugMesh->SetCollisionResponseToAllChannels(ECR_Ignore);
    plugMesh->SetCollisionProfileName("OverlapAll");
